  ...
  void _addChild() {
    if (_children.length >= 5) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Maximum 5 children can be added.')),
      );
      return;
    }
    setState(() {
                      ...
                      children: [
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: _addChild,
                            child: const Text('Add More Children'),
                          ),
                        ),
                        const SizedBox(height: 24),
...
class _ChildForm extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final labelPrefix = 'Child ${index + 1} - ';
