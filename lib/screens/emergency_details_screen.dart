                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage:
                          widget.sitter.profileImageUrl.isNotEmpty
                              ? NetworkImage(widget.sitter.profileImageUrl)
                              : null,
                      child: widget.sitter.profileImageUrl.isEmpty
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("${widget.sitter.distanceLabel} • ETA: 10 mins"),
                      ],
                    ),
                  ),
                  Text(
