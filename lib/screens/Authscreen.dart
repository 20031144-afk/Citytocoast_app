...
import 'package:citytocoast_app/screens/Sitters/sittersHome.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _loginUser() async {
    ...
    try {
      ...
      // Step 3: Route based on Firestore data
      if (role == "parent") {
        ...
        bool isProfileCompleted =
            ...
            (userData.data() as Map).containsKey('isProfileCompleted') &&
            userData['isProfileCompleted'] == true;

        Map<String, dynamic> sitterData;

        if (isProfileCompleted) {
          // Fetch detailed profile from sitters collection
          final sitterDoc = await _firestoreService.getSitterById(uid);
          if (sitterDoc != null) {
            // Sitter object to Map
            sitterData = sitterDoc.toMap();
          } else {
            // Fallback if doc missing despite flag
            sitterData = userData.data() as Map<String, dynamic>;
          }
        } else {
          // Use basic user data
          sitterData = userData.data() as Map<String, dynamic>;
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                SitterDashboardScreen(userData: sitterData, uid: uid),
          ),
        );
      } else {
